...
/**
 * Servlet implementation class SqlRemoteUser
 */
@WebServlet("/SqlRemoteUser")
public class SqlRemoteUser extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            ResultSet rs = statement.executeQuery("select * from sqlRemote;");
